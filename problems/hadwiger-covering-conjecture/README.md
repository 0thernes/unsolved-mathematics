...
> **Atlas Rank #62** · CSS **59.533** · Field: *Discrete Geometry* · Posed: **1957** · Status: `open`

## Plain statement

Every convex body in n-dimensional space can be covered by at most 2^n smaller homothetic copies of itself, with equality only for parallelepipeds.
...
*Originators: Hugo Hadwiger, Friedrich Levi, Israel Gohberg, Alexander Markus.*
