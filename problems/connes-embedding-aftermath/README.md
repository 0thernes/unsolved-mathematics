# The Connes Embedding Problem (Resolved 2020)

> **Atlas Rank #30** · CSS **55.367** · Field: *Operator Algebras* · Posed: **1976** · Status: `recently-resolved`

## Plain statement

Can every type II_1 factor be embedded in an ultrapower of the hyperfinite II_1 factor? Resolved NEGATIVELY in 2020 via MIP* = RE; included as a model case of a long-open problem recently settled, and for its live successor questions.
