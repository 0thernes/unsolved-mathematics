...
> **Atlas Rank #37** · CSS **46.9** · Field: *Complex Analysis* · Posed: **1959** · Status: `active-progress`

## Plain statement

If all roots of a complex polynomial lie in the unit disk, then within distance 1 of each root lies a critical point.
