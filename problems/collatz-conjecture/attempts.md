...
- **Steiner (1977); Simons (2005); Simons–de Weger (2005); Hercher (2023).** Exclusion of $1$-cycles and, more generally, $m$-cycles — $m \le 68$ as published by Simons–de Weger (*Acta Arith.* **117** (2005), DOI 10.4064/aa117-1-3), $m \le 75$ via their method with later verification data (the "$m \ge 76$" cited by Hercher), and $m \le 91$ by Hercher (arXiv:2201.00406, *J. Integer Seq.* **26**) — combining transcendence theory with computation. A near-miss on the cycle half of the problem — but only for bounded cycle complexity.
