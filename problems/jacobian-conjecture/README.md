...
> **Atlas Rank #18** · CSS **68.333** · Field: *Algebraic Geometry* · Posed: **1939** · Status: `open`

## Plain statement

A polynomial map from C^n to C^n with constant nonzero Jacobian determinant has a polynomial inverse.
...
*Originators: Ott-Heinrich Keller.*
