...
> **Atlas Rank #52** · CSS **58.5** · Field: *Dynamical Systems* · Posed: **2010** · Status: `active-progress`

## Plain statement

The Möbius function is asymptotically orthogonal to every observable arising from a topological dynamical system of zero entropy.
