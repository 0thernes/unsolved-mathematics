# The Inscribed Square Problem (Toeplitz)

> **Atlas Rank #23** · CSS **60.2** · Field: *Geometric Topology* · Posed: **1911** · Status: `active-progress`

## Plain statement

Does every simple closed curve in the plane contain four points forming a square?
