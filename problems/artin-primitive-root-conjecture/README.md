...
> **Atlas Rank #32** · CSS **61.833** · Field: *Number Theory* · Posed: **1927** · Status: `active-progress`

## Plain statement

Every integer a that is not −1 or a perfect square is a primitive root modulo infinitely many primes, with a specific positive density.
