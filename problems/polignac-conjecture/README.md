...
> **Atlas Rank #14** · CSS **70.233** · Field: *Number Theory* · Posed: **1849** · Status: `active-progress`

## Plain statement

For every even number k, there are infinitely many prime gaps of size k.
...
*Originators: Alphonse de Polignac.*
