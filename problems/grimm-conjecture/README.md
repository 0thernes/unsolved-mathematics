...
> **Atlas Rank #36** · CSS **51.233** · Field: *Number Theory* · Posed: **1969** · Status: `open`

## Plain statement

Consecutive composite numbers can be assigned distinct prime divisors, one dividing each.
