...
> **Atlas Rank #73** · CSS **54.0** · Field: *Graph Theory* · Posed: **1965** · Status: `active-progress`

## Plain statement

The total chromatic number of any graph (coloring vertices and edges so that adjacent/incident elements differ) is at most the maximum degree plus two.
...
*Originators: Mehdi Behzad, Vadim G. Vizing.*
