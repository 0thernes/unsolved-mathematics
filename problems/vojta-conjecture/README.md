...
> **Atlas Rank #18** · CSS **70.233** · Field: *Diophantine Geometry* · Posed: **1987** · Status: `open`

## Plain statement

A deep height inequality on algebraic varieties, modeled on Nevanlinna's second main theorem, that implies the abc conjecture, the Mordell conjecture, and much of Diophantine geometry.
