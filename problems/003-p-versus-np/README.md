...
> **Atlas Rank #3** · CSS **81.9** · Field: *Computational Complexity Theory* · Posed: **1971** · Status: `open`  · 🏛️ **Millennium Prize Problem**

## Plain statement

Is every problem whose solution can be verified quickly also solvable quickly? Formally, does P = NP?
...
*Originators: Stephen Cook, Leonid Levin, Kurt Gödel (1956 letter).*
